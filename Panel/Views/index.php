		...
		<div class="sidebar-content section">
			<table id="users">
				...
				<?php foreach ($users as $user) { ?>
					<tr onclick="insertEmail('<?= $user->email()?>')">
						<td>
...
<script>
	...
	var insertEmail = function(email){
		var field = $('#form-field-to');
		field.val(field.val() + email);
		field.focusout();
	}

	$('#users').on('init page.dt processing.dt order.dt draw.dt', function () {
